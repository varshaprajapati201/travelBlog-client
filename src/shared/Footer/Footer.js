...
import {
  ...
  FooterLink,
  Heading,
} from "../Footer/components/FooterStyles";
    ...
    <Box style={{ padding: "30px 60px" }}>
      ...
      <Container>
        <Row>
          ...
          <Column id="Ghumakad">
            {/* <Heading><div id="icon"><LuggageIcon/></div>Ghumakad</Heading> */}
            ...
            <span id="Ghumakadinfo">
              Ghumakad is a place to create beautiful photography website and
